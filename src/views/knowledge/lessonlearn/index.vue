  ...
  <div class="app-container">
    ...
    <div class="head-container">
      <div v-if="crud.props.searchToggle">
        ...
        <el-input v-model="query.name" clearable size="small" placeholder="输入Lesson Learn名称搜索" style="width: 200px;" class="filter-item" @keyup.enter.native="crud.toQuery" />
    ...
    <!--查看对话框-->
    <el-dialog append-to-body :visible.sync="showVisible" width="600px">
      <el-form :model="sform" size="small" label-width="150px" :label-position="labelPosition">
        <el-form-item label="系统名称" prop="sysName">{{ sform.sysName }}
        </el-form-item>
        <el-form-item label="标题" prop="name">{{ sform.name }}
        </el-form-item>
        <el-form-item label="现象" prop="appear">{{ sform.appear }}
        </el-form-item>
        <el-form-item label="根本原因" prop="rootCause">{{ sform.rootCause }}
        </el-form-item>
        <el-form-item label="问题防范与经验总结" prop="solution">{{ sform.solution }}
        </el-form-item>
        <el-form-item label="附件链接">
          <div>
            <a
              slot="reference"
              :href="baseApi + '/file/' + sform.docType + '/' + sform.docRealName"
    ...
    >
      ...
      <el-table-column label="Lesson Learn名称" width="400">
        <template slot-scope="scope">
          <el-button type="text" @click="show(scope.row.id)">{{ scope.row.name }}</el-button>
        </template>
      </el-table-column>
