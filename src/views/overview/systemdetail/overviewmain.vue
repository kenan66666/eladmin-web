<template>
  <div class="app-container">
    ...
    <el-container direction="vertical">
      <el-header>系统简况
          <el-button class="titleCU" @click="clickAddButton" :disabled="addDisabled">新增</el-button>
          <el-button class="titleCU" @click="clickModifyButton" :disabled="modifyDisabled">修改</el-button>
      </el-header>
      <el-main>
